 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    except:\n",
    "        print('Sucessfully merge wikipedia data and kaggle metadata')\n",
    "    \n",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "Finish Cleaning wikpedia data\n",
      "Finish Cleaning kaggle movies metadata data\n",
      "Finish combining wikipedia data and kaggle meta data\n",
      "Error Loading ratings file to SQL\n",
      "Finish loading data to SQL \n"
     ]
    },
    {
     "data": {
